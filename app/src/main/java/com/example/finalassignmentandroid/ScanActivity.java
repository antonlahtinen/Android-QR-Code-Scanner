                ...
                if (barcodes.size() != 0) {
                    ...
                    txtBarcodeValue.post(new Runnable()
                    {
                        ...
                        public void run()
                        {
                            ...
                            txtBarcodeValue.setText(qrValue);

                            if(qrValue.startsWith("geo:")) {
                                try {
                                    String[] parts = qrValue.substring(4).split(",");
                                    ...
                                    Toast.makeText(ScanActivity.this, "Invalid geo format in QR code", Toast.LENGTH_SHORT).show();
                                }
                            }
                        }
                    });
